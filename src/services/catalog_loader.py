...
DEFAULT_TROPHIES: list[dict] = [
    # =====================================================================
    #  Catalogo canonico (note.txt) — 70 trofei: 1 Platino, 16 Oro,
    #  18 Argento, 35 Bronzo. Gli slug sono l'identità (sync per slug).
    # =====================================================================
    ...
    {"slug": "podium_guess_100", "name": "Aki-Alduino", "description": "Arriva nel podio 100 volte nel Guess The Game.",
     "icon_emoji": "🎮", "category": "guess", "rarity": "gold", "xp_reward": 400,
     "condition_type": "podium_count", "condition_value": 100, "condition_param": "guess"},
    {"slug": "podium_sound_100", "name": "Shazam Umano", "description": "Arriva nel podio 100 volte nel Sound Quest.",
     "icon_emoji": "🎧", "category": "sound", "rarity": "gold", "xp_reward": 400,
     "condition_type": "podium_count", "condition_value": 100, "condition_param": "sound"},
    ...
    {"slug": "fast_guess_100", "name": "Memoria Fotografica", "description": "Completa Guess The Game sotto i 30 secondi per 100 volte.",
     "icon_emoji": "📸", "category": "guess", "rarity": "gold", "xp_reward": 400,
     "condition_type": "event_count", "condition_value": 100, "condition_param": "guess_sub30"},
    {"slug": "fast_sound_100", "name": "Direttore d'Orchestra", "description": "Completa Sound Quest sotto i 30 secondi per 100 volte.",
     "icon_emoji": "🎼", "category": "sound", "rarity": "gold", "xp_reward": 400,
     "condition_type": "event_count", "condition_value": 100, "condition_param": "sound_sub30"},
    {"slug": "last_guess_100", "name": "Schermo Spento", "description": "Arriva ultimo 100 volte nel Guess The Game.",
     "icon_emoji": "📴", "category": "guess", "rarity": "gold", "xp_reward": 400,
     "condition_type": "event_count", "condition_value": 100, "condition_param": "guess_last_place",
     "hidden": True},
    {"slug": "last_sound_100", "name": "Snake? SNAKE?! SNAAAAAKE", "description": "Arriva ultimo 100 volte nel Sound Quest.",
     "icon_emoji": "🐍", "category": "sound", "rarity": "gold", "xp_reward": 400,
     "condition_type": "event_count", "condition_value": 100, "condition_param": "sound_last_place",
     "hidden": True},
    ...
    {"slug": "podium_guess_50", "name": "Maestro dei Quiz", "description": "Arriva nel podio 50 volte nel Guess The Game.",
     "icon_emoji": "🕹️", "category": "guess", "rarity": "silver", "xp_reward": 200,
     "condition_type": "podium_count", "condition_value": 50, "condition_param": "guess"},
    {"slug": "podium_sound_50", "name": "Orecchio Assoluto", "description": "Arriva nel podio 50 volte nel Sound Quest.",
     "icon_emoji": "🎵", "category": "sound", "rarity": "silver", "xp_reward": 200,
     "condition_type": "podium_count", "condition_value": 50, "condition_param": "sound"},
    ...
    {"slug": "last_trivia_50", "name": "Non so proprio tutto sull'argomento",
     ...
     "hidden": True},
    {"slug": "fast_guess_50", "name": "Ray Tracing Umano", "description": "Completa Guess The Game sotto i 30 secondi per 50 volte.",
     "icon_emoji": "🖥️", "category": "guess", "rarity": "silver", "xp_reward": 200,
     "condition_type": "event_count", "condition_value": 50, "condition_param": "guess_sub30"},
    {"slug": "fast_sound_50", "name": "Radar Sonar", "description": "Completa Sound Quest sotto i 30 secondi per 50 volte.",
     "icon_emoji": "📡", "category": "sound", "rarity": "silver", "xp_reward": 200,
     "condition_type": "event_count", "condition_value": 50, "condition_param": "sound_sub30"},
    {"slug": "last_guess_50", "name": "Texture Incomplete", "description": "Arriva ultimo 50 volte nel Guess The Game.",
     "icon_emoji": "🧱", "category": "guess", "rarity": "silver", "xp_reward": 200,
     "condition_type": "event_count", "condition_value": 50, "condition_param": "guess_last_place",
     "hidden": True},
    {"slug": "last_sound_50", "name": "Sordo come una Campana", "description": "Arriva ultimo 50 volte nel Sound Quest.",
     "icon_emoji": "🔕", "category": "sound", "rarity": "silver", "xp_reward": 200,
     "condition_type": "event_count", "condition_value": 50, "condition_param": "sound_last_place",
     "hidden": True},
    ...
    {"slug": "podium_guess_10", "name": "Indovina Chi?", "description": "Arriva nel podio 10 volte nel Guess The Game.",
     "icon_emoji": "🎮", "category": "guess", "rarity": "bronze", "xp_reward": 100,
     "condition_type": "podium_count", "condition_value": 10, "condition_param": "guess"},
    {"slug": "podium_sound_10", "name": "Buon Orecchio", "description": "Arriva nel podio 10 volte nel Sound Quest.",
     "icon_emoji": "🎧", "category": "sound", "rarity": "bronze", "xp_reward": 100,
     "condition_type": "podium_count", "condition_value": 10, "condition_param": "sound"},
    ...
    {"slug": "last_trivia_10", "name": "Rimandato", "description": "Arriva ultimo 10 volte nel Trivia Nerd.",
     ...
     "hidden": True},
    {"slug": "podium_guess_1", "name": "Veni, Vidi, Vici", "description": "Raggiungi il podio per la prima volta nel Guess The Game.",
     "icon_emoji": "🏛️", "category": "guess", "rarity": "bronze", "xp_reward": 50,
     "condition_type": "podium_count", "condition_value": 1, "condition_param": "guess"},
    {"slug": "podium_sound_1", "name": "A caccia di indizi", "description": "Raggiungi il podio per la prima volta nel Sound Quest.",
     "icon_emoji": "🔎", "category": "sound", "rarity": "bronze", "xp_reward": 50,
     "condition_type": "podium_count", "condition_value": 1, "condition_param": "sound"},
    {"slug": "fast_guess_10", "name": "Occhio di Falco", "description": "Completa Guess The Game sotto i 30 secondi per 10 volte.",
     "icon_emoji": "🦅", "category": "guess", "rarity": "bronze", "xp_reward": 50,
     "condition_type": "event_count", "condition_value": 10, "condition_param": "guess_sub30"},
    {"slug": "fast_sound_10", "name": "Orecchie da mercante", "description": "Completa Sound Quest sotto i 30 secondi per 10 volte.",
     "icon_emoji": "👂", "category": "sound", "rarity": "bronze", "xp_reward": 50,
     "condition_type": "event_count", "condition_value": 10, "condition_param": "sound_sub30"},
    {"slug": "last_guess_10", "name": "Miope", "description": "Arriva ultimo 10 volte nel Guess The Game.",
     "icon_emoji": "👓", "category": "guess", "rarity": "bronze", "xp_reward": 50,
     "condition_type": "event_count", "condition_value": 10, "condition_param": "guess_last_place",
     "hidden": True},
    {"slug": "last_sound_10", "name": "Rumore Bianco", "description": "Arriva ultimo 10 volte nel Sound Quest.",
     "icon_emoji": "📺", "category": "sound", "rarity": "bronze", "xp_reward": 50,
     "condition_type": "event_count", "condition_value": 10, "condition_param": "sound_last_place",
     "hidden": True},
